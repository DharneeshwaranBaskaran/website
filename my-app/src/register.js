    ...
    return ( 
        ...
        <div style={{padding:"35px"}}></div>
            <div className="app" >
                ...
                {localStorage.getItem('type') === 'seller' && renderInputField("text", "Name", name, handleChange5, inputStyle4)}
                <div style={errorStyle}>{error4}</div> 
        
                {localStorage.getItem('type') !== 'buyer' && renderInputField("text", "Contact Number", num, handleChange6, inputStyle5)}
                <div style={errorStyle}>{error5}</div>
                {localStorage.getItem('type') !== 'buyer' && renderInputField("text", "Company", company, handleChange7, inputStyle6)}
                ...
                {localStorage.getItem('type') !== 'company' && renderInputField("text", "Personal Address", address, handleChange4)}
                {localStorage.getItem('type') !== 'buyer' && renderInputField("text", "Company Address", comaddress, handleChange8)}
                {localStorage.getItem('type') === 'company' && renderInputField("text", "Website", website, handleChange9)}
                </div>
